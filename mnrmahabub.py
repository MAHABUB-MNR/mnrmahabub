...
os.system('xdg-open https://youtube.com/@mnrmedia7613')
os.system('espeak -a 300 "CREATE BY mnrmedia7613"') 
...
os.system('xdg-open https://t.me/+Z0v4cDAZBV9lNWVl')
...
os.system('espeak -a 300 "mahabub bot hacker tool"')
logo= f'''
...
\033[1;97m Owner  : MAHABUB ISLAM

\033[1;97m GitHub : MAHABUB-MNE/

\033[1;97m Version:\033[1;92m 0.2 \033[1;97m:/

\033[1;97m YouTub: MNR-MAHABUB

\033[1;97m Team : MAHABUB-MNR
...
def Axi_Main():
    ...
    os.system('espeak -a 300 "Tools Admin MAHABUB  File Crack Pak Random Crack Gmail Crack.     Create Dump File"')
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/MAHABUB-MNR/FILE')
...
def andom():
    ...
    'cache-control': 'max-age=0',
     ...
     'cookie': 'sb=LBN_ZDPq7HxNACkbldedtnY1; datr=LBN_ZAFQTUNFBfIrhINvvyhg; wd=980x1873; dpr=2; fr=0wKhsNycc6JOIYHB5..BkfxMs.6P.AAA.0.0.BkiumT.AWXBboy8MVQ',
